...
<ol>
  ...
  <li>In one terminal you type ./recv and you'll see that nothing has changed. But if go to the second terminal and type ls you'll see there's a keyfile.txt</li>
